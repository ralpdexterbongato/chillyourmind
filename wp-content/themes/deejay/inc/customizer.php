...
function deejay_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'deejay_textcolor',		array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'        => null,
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'deejay_textcolor', array(
	...
	$wp_customize->add_setting( 'deejay_accent_color',		array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'        => '#4ac6c9',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'deejay_accent_color', array(
	...
	$wp_customize->add_setting( 'deejay_link_underline_color',		array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'        => '#b902c4',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'deejay_link_underline_color', array(
	...
	$wp_customize->add_setting( 'deejay_header_bgcolor', array(
		'sanitize_callback' => 'sanitize_hex_color',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'deejay_header_bgcolor', array(
	...
	$wp_customize->add_setting( 'deejay_menu_site_icon', array(
		'sanitize_callback' => 'deejay_sanitize_checkbox',
	) );

	$wp_customize->add_control('deejay_menu_site_icon', array(
		'type' => 'checkbox',
	...
	$wp_customize->add_section( 'deejay_crew', array(
	...
	for ( $i = 1; $i < 9; $i++ ) {
		$wp_customize->add_setting( 'deejay_crew_member' . $i, array(
			'sanitize_callback' => 'deejay_sanitize_select',
		) );

		$wp_customize->add_control( 'deejay_crew_member' . $i, array(
			'type' => 'select',
